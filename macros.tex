...
\tikzset{%
  ...
  numbers/.style = {white,text width=2ex,font=\footnotesize\itshape},
  ...
  thanks/.style = {black,thick,text width=\textwidth,font=\footnotesize,align=center,inner sep=.5em,outer sep=0pt},
}

\pdfinfo{%
  /Title (WSP -- Word Search Puzzle)
  /Creator (Thiago de Melo)
  /Author (Thiago de Melo, Patrick McAllister)
}
